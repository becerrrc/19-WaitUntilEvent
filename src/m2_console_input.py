...
def print_an_integer_many_times():
    ...
    print()
    print('--------------------------------------------------')
    print('Demonstrating  CONSOLE INPUT   of a MANY INTEGERS:')
    print('--------------------------------------------------')
...
def print_an_integer_many_times_on_one_row():
    ...
    print()
    print('--------------------------------------------------')
    print('Demonstrating  CONSOLE INPUT   of a MANY INTEGERS one row:')
    print('--------------------------------------------------')
...
def input_it_all():
    ...
    print()
    print('--------------------------------------------------')
    print('Demonstrating  CONSOLE INPUT   of a FLOATING POINT & STRING:')
    print('--------------------------------------------------')

    number = float(input('Enter pos: '))
    new = math.sqrt(number)
